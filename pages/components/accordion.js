...
export default function Accordion({title, content, isExpanded, toggle}) {
    ...
    return (
        ...
        <div className={isExpanded === true ? 'cpl-2 md:pl-7 lg:pl-11 pr-4 pb-2 transition-all duration-500 ease-in-out' : 'pl-2 md:pl-7 lg:pl-11 pr-4 pb-2 transition-all duration-500 ease-in-out hidden'}>
            {content}
        </div>
